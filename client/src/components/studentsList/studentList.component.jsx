...
initComponent();
  ...
  return (
    <>
      ...
      <tbody>
        {studentsArr.length > 0 ? studentsArr.map((s) => {
     return <StudentRow ID={s.StudentID} FullName={s.fullName} Grade={s.grade} Hobby={s.hobby} ></StudentRow>
    }): <Spinner animation="border" role="status">
      <span className="visually-hidden">Loading...</span>
    </Spinner>}
         </tbody>
    </Table>
    <DeleteStudent handleDelete={HandeDelete}></DeleteStudent>
    </>
  )
}
